...
//
// Installed versions, pinned EXACT (npm registry):
...
export default tseslint.config(
  ...
  // Also ignore installed deps / Next build output anywhere, and next-env.d.ts (generated by
  // `next build`, matches the apps/**/*.ts glob below and its triple-slash refs are lint bait).
  {
    ignores: [
      ...
      // for the root test) otherwise crashes the type-info rules ("no parserServices").
      "**/*.d.ts",
      "**/*.d.mts",
    ],
  },
  ...tseslint.configs.recommendedTypeChecked,
  {
    ...
    // appended at the end. apps/harness IS a node package in the root program (tsconfig
  ...
  // (ADR-M004 D10) — apps/site (Next.js) is covered by the ROOT
